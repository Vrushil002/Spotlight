...
<footer class="py-5 bg-gradient-navy">
  <div class="container">
    <p class="m-0 text-center text-white">Copyright &copy;
      <?php echo $_settings->info('short_name') ?> 2023
    </p>
    <p class="m-0 text-center text-white">Developed By: <a
        href="mailto:kalsariyavrushil1676@gmail.com">kalsariyavrushil1676</a></p>
  </div>
</footer>
